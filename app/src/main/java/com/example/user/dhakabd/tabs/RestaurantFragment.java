...
public class RestaurantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_restaurant, container, false);
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference().child("Restaurant");
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter(mContents,getContext(),"Restaurant");
