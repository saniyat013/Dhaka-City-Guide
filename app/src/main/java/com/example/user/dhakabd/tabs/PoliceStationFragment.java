...
public class PoliceStationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_police_station, container, false);
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference().child("PoliceStation");
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter(mContents,getContext(),"PoliceStation");
