...
public class InstituteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference().child("Institutes");
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter(mContents,getContext(),"Institutes");
